...
label_idx_dir = os.path.join(root_dir, "Labeled_idx_CS")
...
train_file = os.path.join(root_dir, "trainCS.csv")
val_file   = os.path.join(root_dir, "valCS.csv")
test_file  = os.path.join(root_dir, "testCS.csv")
    ...
    for label_dir, index_dir, csv_file in zip([train_dir, val_dir, test_dir], [train_idx_dir, val_idx_dir, test_idx_dir], [train_file, val_file, test_file]):
        ...
        for city in os.listdir(label_dir):
            ...
            for filename in os.listdir(city_dir):
                ...
                Image.fromarray(idx_mat, mode='L').save(lab_name)
